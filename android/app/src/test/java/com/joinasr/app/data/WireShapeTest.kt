        ...
        val body = PactCreate(
            ...
            snapshot = PactSnapshot(
                ...
                activities = ActivityRules(
                    ...
                    plank = ActivityRule(rewardMinutes = 15, dailyCapMinutes = 60, target = 45),
                    ...
                    cycling = ActivityRule(rewardMinutes = 15, dailyCapMinutes = 60, target = 3000),
                    meditation = ActivityRule(rewardMinutes = 15, dailyCapMinutes = 60, targetMinutes = 7),
                ),
            ),
        )
