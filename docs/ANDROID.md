...
| `plank` | Same camera and model | Head-on from a phone stood upright ahead of the hands: eyes no higher than a third of a shoulder width above the shoulder line, hips (when seen) behind the shoulders and not below them; or from the side, shoulder, hip and ankle in one straight line sloping to the feet. Timed; 45 seconds, breaks pause the clock. `android/PUSH_UPS.md` |
...
| `meditation` | Same camera and model | Sitting upright and facing the phone (nose, shoulders, hips and knees seen, shoulders level and wide, torso near vertical, each thigh sideways or foreshortened rather than hanging a torso long, no straight long leg to an ankle, hips within 0.6 of a torso of where they were when the clock started; standing never counts) and still (head and shoulders drift under 0.2 and 0.12 of a torso a second), timed; 7 minutes in one sitting, a break of three seconds or more starts it over. `android/MEDITATION.md` |
