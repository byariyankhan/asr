...
| `plank` | Same camera and model | Head-on from a phone stood upright just ahead of the hands: face and shoulders seen, shoulders level, hips (when seen) behind the shoulders and under 0.8 of a width below them, and the body up off the floor by either an arm (elbow at least 0.38 of a width below its shoulder or wrist at least 0.8, no elbow tucked by the shoulder, no forearm flat under a low shoulder) or, with the arms below the frame, the face drawn nearer than the shoulders (eyes at least 0.22 of a width apart); or from the side, shoulder, hip and ankle in one straight line sloping to the feet. Timed; 45 seconds, breaks pause the clock. `android/PUSH_UPS.md` |
