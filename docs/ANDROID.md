...
| `meditation` | Same camera and model | Sitting upright and facing the phone (nose, shoulders and hips seen, shoulders level and wide, torso near vertical, hips within 0.6 of a torso of where they were when the clock started) and still (head and shoulders drift under 0.2 and 0.12 of a torso a second), timed; 7 minutes in one sitting, a break of three seconds or more starts it over. `android/MEDITATION.md` |
